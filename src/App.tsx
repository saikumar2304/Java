...
import HandsOnBasics from './pages/hands-on/HandsOnBasics';
...
// Hands-on Exercises
import ArraysExercises from './pages/hands-on/arrays/ArraysExercises';
import ArrayExercise from './pages/hands-on/arrays/ArrayExercise';
import StringsExercises from './pages/hands-on/strings/StringsExercises';
import StringExercise from './pages/hands-on/strings/StringExercise';
import CollectionsExercises from './pages/hands-on/collections/CollectionsExercises';
import CollectionExercise from './pages/hands-on/collections/CollectionExercise';
import FlowControl from './pages/hands-on/FlowControl';
import FlowControlExercise from './pages/hands-on/flow-control/FlowControlExercise';
import MethodsExercises from './pages/hands-on/methods/MethodsExercises';
import MethodExercise from './pages/hands-on/methods/MethodExercise';
import OOPExercises from './pages/hands-on/oop/OOPExercises';
import OOPExercise from './pages/hands-on/oop/OOPExercise';
import ExceptionExercises from './pages/hands-on/exceptions/ExceptionExercises';
import ExceptionExercise from './pages/hands-on/exceptions/ExceptionExercise';
import FileExercises from './pages/hands-on/files/FileExercises';
import FileExercise from './pages/hands-on/files/FileExercise';
